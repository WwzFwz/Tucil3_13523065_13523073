...
public class GreedySolver implements Solver {
    ...
    public GreedySolver(Heuristic heuristic) {
    ...
    private static class Node {
        ...
        Node(Board board, List<Movement> path, int h) {
            this.board = board;
            this.path = path;
            this.h = h;
        }
    ...
    public Result solve(Board initial) {
        ...
        Node startNode = new Node(initial, new ArrayList<>(), h);
        open.add(startNode);
        ...
        while (!open.isEmpty()) {
            ...
            for (var child : generateChildren(current)) {
                ...
                open.add(new Node(child.board, newPath, hNew));
            }
        }
